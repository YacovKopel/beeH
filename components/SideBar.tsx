...
function SideBar() {
  return (
    <div className="flex flex-col items-center justify-center px-2 text-black">
      <h1 className="text-5xl font-bold mb-20">LOGO</h1>
      <div className="flex space-x-2 text-center">
        <div>
          <div className="flex flex-col items-center justify-between mb-10">
            <ChartBarSquareIcon className="h-8 w-8 mb-10" />
            <ArchiveBoxIcon className="h-8 w-8 mb-10" />
